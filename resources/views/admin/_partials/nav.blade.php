...
<ul class="c-sidebar-nav ps ps--active-y">
    ...
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="colors.html">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-drop') ?>"></use>
            </svg> Colors</a></li>
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="typography.html">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-pencil') ?>"></use>
            </svg> Typography</a></li>
    <li class="c-sidebar-nav-title">Components</li>
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-puzzle') ?>"></use>
            </svg> Base</a>
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-cursor') ?>"></use>
            </svg> Buttons</a>
        <ul class="c-sidebar-nav-dropdown-items">
    ...
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="charts.html">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-chart-pie') ?>"></use>
            </svg> Charts</a></li>
    <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-star') ?>"></use>
            </svg> Icons</a>
        <ul class="c-sidebar-nav-dropdown-items">
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-bell') ?>"></use>
            </svg> Notifications</a>
        <ul class="c-sidebar-nav-dropdown-items">
    ...
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="widgets.html">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-calculator') ?>"></use>
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="login.html" target="_top">
                    <svg class="c-sidebar-nav-icon">
                    <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-account-logout') ?>"></use>
                    </svg> Login</a></li>
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="404.html" target="_top">
                    <svg class="c-sidebar-nav-icon">
                    <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-bug') ?>"></use>
                    </svg> Error 404</a></li>
    ...
    <li class="c-sidebar-nav-item mt-auto"><a class="c-sidebar-nav-link c-sidebar-nav-link-success" href="https://coreui.io" target="_top">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-cloud-download') ?>"></use>
    ...
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link c-sidebar-nav-link-danger" href="https://coreui.io/pro/" target="_top">
            <svg class="c-sidebar-nav-icon">
            <use xlink:href="<?= url('/assets/admin/icons/sprites/free.svg#cil-layers') ?>"></use>
