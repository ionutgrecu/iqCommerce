                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="bootexpert-billing-fields">
                                                                ...
                                                                <p class="form-row form-row-first">
                                                                    ...
                                                                    <input type="text" class="input-text " name="name" placeholder="" value="<?= old('name',  Auth::user()->name)?>" />
                                                                </p>
                                                                <div class="clear"></div>
                                                                <p class="form-row form-row-first validate-email" id="billing_email_field">
                                                                    ...
                                                                    <input type="email" class="input-text " name="email" placeholder="" value="<?=old('email',Auth::user()->email)?>" />
                                                                </p>
                                                                ...
                                                                <p class="form-row form-row-wide address-field update_totals_on_change" id="billing_country_field">
                                                                    ...
                                                                    <noscript>
                                                                    <input type="submit" name="bootexpert_checkout_update_totals" value="Update country" />
                                                                    </noscript>
                                                                </p>
                                                                ...
                                                                <p class="form-row form-row-last address-field validate-postcode" id="billing_postcode_field">
                                                                    ...
                                                                    <input type="text" class="input-text " name="billing_postcode" id="billing_postcode" placeholder="Zip" value="" />
                                                                </p>
                                                                <div class="clear"></div>
                                                                ...
                                                                <div class="create-account">
                                                                    ...
                                                                    <p class="form-row form-row">
                                                                        ...
                                                                        <input type="password" class="input-text " name="account_password" placeholder="Password" value="" />
                                                                    </p>
                                                                    <div class="clear"></div>
                                                                </div>
                                                            </div>
                                                            <div class="bootexpert-shipping-fields">
                                                            ...
                                                            <div class="order-box">
                                                                ...
                                                                <div id="order_review" class="bootexpert-checkout-review-order">
                                                                    <table class="shop_table bootexpert-checkout-review-order-table">
                                                                        ...
                                                                        <tbody>
                                                                            <tr class="cart_item">
                                                                                <td class="product-name">Condimentum posuere&nbsp;<strong class="product-quantity">&times; 1</strong></td>
                                                                                <td class="product-total"> <span class="amount">&pound;115.00</span></td>
                                                                            </tr>
                                                                            <tr class="cart_item">
                                                                                <td class="product-name">Quisque fringilla&nbsp; <strong class="product-quantity">&times; 1</strong></td>
                                                                                <td class="product-total"> <span class="amount">&pound;45.00</span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                        <tfoot>
                                                                            <tr class="cart-subtotal">
                                                                                <th>Subtotal</th>
                                                                                <td><span class="amount">&pound;160.00</span></td>
                                                                            </tr>
                                                                            <tr class="shipping">
                                                                                <th>Shipping</th>
                                                                                <td>
                                                                                    <ul id="shipping_method">
                                                                                        <li>
                                                                                            <input type="radio" name="shipping_method" value="flat_rate" class="shipping_method" />
                                                                                            <label>Flat Rate: <span class="amount">&#036;7.00</span></label>
                                                                                        </li>
                                                                                        <li>
                                                                                            <input type="radio" name="shipping_method" value="free_shipping" checked='checked' class="shipping_method" />
                                                                            ...
                                                                            <tr class="order-total">
                                                                                <th>Total</th>
                                                                                <td><strong><span class="amount">&pound;160.00</span></strong></td>
                                                                            </tr>
                                                                        </tfoot>
                                                                    </table>
                                                                    <div id="payment" class="bootexpert-checkout-payment">
                                                                        <ul class="payment_methods methods">
                                                                            <li class="payment_method_cheque">
                                                                                <input id="payment_method_cheque" type="radio" class="input-radio" name="payment_method" value="cheque" checked='checked' />
                                                                            ...
                                                                            <li class="payment_method_paypal">
                                                                                ...
                                                                                <label>PayPal
                                                                                    <img src="images/fashion/brand/payment-c.png" alt="PayPal Acceptance Mark" />
                                                                                    <a href="" class="about_paypal" title="What is PayPal?">What is PayPal?</a> 
                                                                                </label>
                                                                            </li>
                                                                        </ul>
                                                                        <div class="form-row place-order">
                                                                            <input type="submit" class="button alt" name="bootexpert_checkout_place_order" id="place_order" value="Place order" />
                                                                        </div>
                                                                        <div class="clear"></div>
                                                                    </div>
                                                                </div>
