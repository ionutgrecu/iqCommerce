...
class CreateCategoryCharacteristicsTable extends Migration {
    ...
    public function up() {
        Schema::create('category_characteristics', function (Blueprint $table) {
            ...
            $table->string('append_field',255)->nullable()->description('Append this string to the field. Ex.: $field g/mp');
            $table->string('prepend_field',255)->nullable()->description('Prepend this string to the field.');
